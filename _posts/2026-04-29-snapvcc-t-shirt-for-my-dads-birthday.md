...
Sidenote - Procreate is a very usefull software and is great to do digital art. It provides animation assist, guidelines, adn many different brushes you can choose from (this is not an advertisement)

Heres a picture of my drawing of the snap VCC. 
![snapVCCdrawing](images/2026/snapVCCdrawing)

With the help if my mom, we found a nice gym shirt we can get my artowkr printed on suing this website called printo.

Sidenote - Printo offers lots of differnet shirt types and clothing on which you can print your persoinal prints (also not an advertizment)

After looking at different types of shirts we chose a black gym shirt to print the design on. I made my design white for contrast.

This is the final product(image below)

Making this shirt for my dad was a lot of fun.
